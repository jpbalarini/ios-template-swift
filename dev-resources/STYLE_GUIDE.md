...
Most of this guide takes ideas form excellent [Ray Wenderlich's](raywenderlich.com) site.

The main goal of this guide is to help achieving conciseness, readability, and simplicity.
...
* Indent using 4 spaces rather than tabs to conserve space and help prevent line wrapping. Be sure to set this preference in Xcode (Preferences->Text Editing->Indentation)
