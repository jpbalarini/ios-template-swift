...
mogenerator --swift --model "${INPUT_FILE_PATH}/" --machine-dir "${PROJECT_DIR}/iOS-Template/CoreData/Private/" --human-dir "${PROJECT_DIR}/iOS-Template/CoreData/" --template-var arc=true
